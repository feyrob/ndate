...
void print_help(){
	...
	printf("\n");
	printf("## Synopsis\n");
	printf("ndate now            utc/local simple/compat/fancy\n");
	printf("ndate filemod <path> utc/local compat/simple/fancy\n");
	printf("\n");
	printf("## Examples\n");
	printf("ndate now\n");
...
enum e_tformat{tformat_invalid, tformat_simple, tformat_compat, tformat_fancy};
